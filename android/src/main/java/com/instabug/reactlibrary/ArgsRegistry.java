...
final class ArgsRegistry {
    ...
    static ArgsMap<InstabugInvocationEvent> invocationEvents = new ArgsMap<InstabugInvocationEvent>() {{
        ...
        put("invocationEventTwoFingersSwipe", InstabugInvocationEvent.TWO_FINGER_SWIPE_LEFT);

        // TODO: Remove after Unifying initialization
        //  and removing code in RNInstabugReactnativePackage
        put("none", InstabugInvocationEvent.NONE);
        put("shake", InstabugInvocationEvent.SHAKE);
        put("button", InstabugInvocationEvent.FLOATING_BUTTON);
        put("screenshot", InstabugInvocationEvent.SCREENSHOT);
        put("swipe", InstabugInvocationEvent.TWO_FINGER_SWIPE_LEFT);
    }};
    ...
    static final ArgsMap<Integer> invocationOptions = new ArgsMap<Integer>() {{
        ...
        // Deprecated
        put("emailFieldHidden", Option.EMAIL_FIELD_HIDDEN);
        put("emailFieldOptional", Option.EMAIL_FIELD_OPTIONAL);
        put("commentFieldRequired", Option.COMMENT_FIELD_REQUIRED);
        put("disablePostSendingDialog", Option.DISABLE_POST_SENDING_DIALOG);
    }};
